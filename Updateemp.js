...
const Updateemp = () => {
    ...
    const worklocationadd = async () => {
        try {
            const res = await axios.get("http://localhost:8001/worklocation")
    ...
    const updatesetdata = async () => {
        try {
            ...
            const res = await axios.get("http://localhost:8001/update", 
            { params: { eid } })
    ...
    const handlesubmit = async (e) => {
        ...
        if (!firstname) {
           ...
           const res = await axios.post("http://localhost:8001/updatesetdata",{
                eid : eid,
                firstname : firstname,
                lastname : lastname,
                contactno : contactno,
